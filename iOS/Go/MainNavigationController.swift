...
class MainNavigationController: UINavigationController {
    ...
    override func viewDidLoad() {
        ...
        navigationBar.barTintColor = UIColor.go_main_color()
...
//        layoutMenuViews()
    ...
    func menuButtonAction() {
        ...
        if menuConstraint.constant == 0 {
            menuConstraint.constant =  (menuView.bounds.height - fillerButton.bounds.height)
        }
        else {
    ...
    func setupMenuView() {
        ...
        inboxButton.backgroundColor = UIColor.go_yellow()
        ...
        notificationButton.backgroundColor = UIColor.go_light_blue()
